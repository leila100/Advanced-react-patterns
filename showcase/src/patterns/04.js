...
const ClapCount = ({ style: userStyles = {} }) => {
  ...
  return (
    <span ref={setRef} data-refkey='countRef' className={styles.count} style={userStyles}>
      + {count}
    </span>
  );
};
...
const ClapTotal = ({ style: userStyles = {} }) => {
  ...
  return (
    <span ref={setRef} data-refkey='totalRef' className={styles.total} style={userStyles}>
      {countTotal}
    </span>
  );
};
...
const Usage = () => {
  ...
  return (
    <div style={{ width: "100%" }}>
      <MediumClap onClap={handleClap} style={{ background: "#003355" }}>
        <MediumClap.Icon />
        <MediumClap.Count style={{ background: "#8cacea", color: "black" }} />
        <MediumClap.Total style={{ background: "#8cacea", color: "black", padding: "3px" }} />
      </MediumClap>
